...
test('difference should remove duplicates', () => {
  var a = ['a', 'b', 1, 'b']
  var b = ['c', 'a', 1]
  var c = [1, 2, 3, 'a']
...
test('difference should return an empty array if items are present on other arrays', () => {
  var a = ['b', 'a', 'c', 1, 2, 3]
  var b = ['c', 'a']
  var c = [1, 'b', 2, 3, 'a']
...
test('differnce should use empty array if null/undefined', function () {
  var arr = [1, 2]
