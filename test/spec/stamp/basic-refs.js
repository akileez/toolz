...
// Basics refs
// deprecated as of stampit v3 ... reference (refs) alias to properties

test('stampit({ refs }) -- syntax no longer in use -- adjustments made', () => {
...
test('stampit({ refs }).refs() -- syntax no longer in use -- adjustments made', () => {
  const obj = stampit()
    .refs({
      foo: {bar: 'bar'},
      refsOverride: false,
